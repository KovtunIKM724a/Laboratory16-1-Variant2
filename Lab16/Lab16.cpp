...
using namespace std;
/*
Abiturient: Прізвище, Ім'я, По батькові, Адреса, Оцінки. Створити
масив об'єктів, вивести:
а) список абітурієнтів, що мають незадовільні оцінки;
б) список абітурієнтів, сума балів у яких не менше заданої;
в) вибрати N абітурієнтів, що мають найвищу суму балів, і список
абітурієнтів, що мають напівпрохідний бал.
*/
